...
async def download_core_without_git():
    folder_name = "vitap_vtop_client"
    if not os.path.exists(folder_name):
        print(f"[-] {folder_name} missing. Downloading ZIP...")
        
        # GitHub's automatic zip URL for the main branch
        url = "https://github.com/VITAP-Student-Project/vitap_vtop_client/archive/refs/heads/main.zip"
        ...
        # Move the inner folder to your project root
        os.rename("temp_folder/vitap_vtop_client-main", folder_name)
        
        # Cleanup
        os.remove("temp.zip")
        print("[+] Core client setup complete!")
